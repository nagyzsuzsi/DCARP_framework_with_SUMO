...
class gc:
    ...
    @classmethod
    def add_vehicle(self, v, t):
        gc.vehicles.append(v)
        gc.vehicles_depart_time[v] = int(t)
...
class routine():    # route plan
    ...
    def complete(self):
        ...
        self.cost = cal_route_cost_with_vt(self.tasks_seqs) # calculates cost at the end
